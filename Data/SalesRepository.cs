...
namespace QuanLySieuThi.Data
{
    public class SalesRepository
    {
        ...
        {
            string nbđ = vc.NgayBatDau.Year + "-" + vc.NgayBatDau.Month + "-" + vc.NgayBatDau.Day;
            string nkt = vc.NgayKetThuc.Year + "-" + vc.NgayKetThuc.Month + "-" + vc.NgayKetThuc.Day;
            return "VC|" + vc.MaVoucher + "|" + vc.TenVoucher + "|" + vc.LoaiVoucher + "|" +
                   vc.GiaTri + "|" + nbđ + "|" + nkt + "|" + vc.DKApDung + "|" + vc.TrangThai;
        }
    }
}