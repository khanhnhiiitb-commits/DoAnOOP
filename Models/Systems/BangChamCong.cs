...
{//sua
    public class BangChamCong
    {
        ...
        {   get { return thang; }
            set 
            {
                if (value >= 1 && value <= 12)  thang = value;
                else  thang = 1;
            }
        }
        public int Nam
        ...
        {  get { return soNgayNghi; }
            set 
            {
                if (value >= 0 && value <= 31)   soNgayNghi = value;
                else  soNgayNghi = 0;
            }
        }
        ...
        public int TinhTongCong() { return soNgayLamViec + soNgayNghi; }
